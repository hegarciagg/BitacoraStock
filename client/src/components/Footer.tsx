        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div className="text-xl font-bold text-white">MAIN<span className="text-primary">STOCK</span></div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-slate-400 text-sm">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Estado de la API</a></li>
