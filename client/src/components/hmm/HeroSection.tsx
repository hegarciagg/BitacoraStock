...
const TECH_BADGES = [
  ...
  { label: "Express", color: "bg-slate-500/15 text-slate-700 border-slate-500/30" },
        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div>
            ...
            <p className="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
              ...
              <span className="text-slate-900 font-semibold">Hidden Markov Models</span>{" "}
          ...
          <div className="grid grid-cols-3 gap-4 w-full max-w-md">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 border border-slate-300">
              <p className="text-2xl font-bold text-slate-900">7</p>
              <p className="text-xs text-slate-500">Estados HMM</p>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 border border-slate-300">
              <p className="text-2xl font-bold text-slate-900">8</p>
              <p className="text-xs text-slate-500">Confirmaciones</p>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 border border-slate-300">
              <p className="text-2xl font-bold text-slate-900">1.3x</p>
