...
// ─── Backtesting: Eventos Históricos ───────────────────────────
...
// ─── Sentimiento: Datos de ejemplo ─────────────────────────────
const SENTIMENT_DATA = {
  overallSentiment: 0.35,
  marketConfidence: 0.72,
  correlations: [
    { asset: "AAPL", sentimentImpact: 0.35, historicalCorrelation: 0.75, confidence: 0.63, expectedMovement: 2.63 },
    { asset: "MSFT", sentimentImpact: 0.35, historicalCorrelation: 0.72, confidence: 0.61, expectedMovement: 2.52 },
    { asset: "SPY", sentimentImpact: 0.35, historicalCorrelation: 0.65, confidence: 0.56, expectedMovement: 2.28 },
    { asset: "QQQ", sentimentImpact: 0.35, historicalCorrelation: 0.70, confidence: 0.60, expectedMovement: 2.45 },
    { asset: "BTC", sentimentImpact: 0.35, historicalCorrelation: 0.85, confidence: 0.71, expectedMovement: 2.98 },
  ],
  riskAdjustment: 1.15,
...
// ═══════════════════════════════════════════════════════════════
// Componente Principal: Analysis Hub
// ═══════════════════════════════════════════════════════════════
...
function SentimentTab() {
  ...
  const sentimentData = useMemo(() => SENTIMENT_DATA, []);
