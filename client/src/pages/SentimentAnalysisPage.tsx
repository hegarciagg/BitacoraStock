    ...
    return (
      <DashboardLayout>
        <div className="text-center py-12">
          <p className="text-slate-500">Por favor inicia sesión para acceder a esta página</p>
        </div>
      </DashboardLayout>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-2">Correlación de noticias con movimientos históricos del mercado</p>
          </div>
          <Button
